...
generated: true
---
<GenerationInfo sourceFile="packages/core/src/service/services/collection.service.ts" sourceLine="79" packageName="@vendure/core" />
